...
//        article.setNodeId(node.getName());
//        article.setTitle(node.getProperty("title").getString());
//        article.setCreatedBy(node.getProperty("author").getString());
//
//        if (node.hasProperty("createdDate")) {
//            article.setCreatedDate(node.getProperty("publishDate").getDate().toInstant());
//        }
//
...
//        Node node = parent.addNode(article.getNodeId());
//        node.setProperty("title", article.getTitle());
//        node.setProperty("author", article.getCreatedBy());
//
